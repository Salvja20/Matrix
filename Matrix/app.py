...
<main>
  ...
  <div class="toolbar">
    ...
    <button class="example-btn" onclick="loadExample('math')">Math Ops</button>
    ...
    <button class="example-btn" onclick="loadExample('module')">Module</button>
    <button class="example-btn" onclick="loadExample('loop')">Loop</button>
    <button class="example-btn" onclick="loadExample('errors')">Errors</button>
